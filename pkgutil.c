...
#ifdef ARCHIVE_EXTRACT_WINDOWS_SYMLINK_FALLBACK
#define PKGUTIL_WINDOWS_SYMLINK_FALLBACK ARCHIVE_EXTRACT_WINDOWS_SYMLINK_FALLBACK
#else
#define PKGUTIL_WINDOWS_SYMLINK_FALLBACK 0
#endif
